...
@OnlyIn(Dist.CLIENT)
public class BumbleguardModel<T extends Bumbleguard> extends AgeableListModel<T> {
    ...
    public BumbleguardModel(ModelPart pRoot) {
    ...
    public void prepareMobModel(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pPartialTick) {
        ...
        this.rollAmount = 0; //pEntity.getRollAmount(pPartialTick);
        this.stinger.visible = true;//!pEntity.hasStung();
    }
    ...
    public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
        ...
        this.bone.xRot = 0.0F;
        boolean flag = pEntity.onGround() && pEntity.getDeltaMovement().lengthSqr() < 1.0E-7;
        if (flag) {
            ...
            float f = pAgeInTicks * 120.32113F * (float) (Math.PI / 180.0);
